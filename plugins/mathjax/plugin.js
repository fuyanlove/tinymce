tinymce.PluginManager.add("mathjax", function (editor, url) {
    ...
    let mathjaxSymbols = editor.settings.mathjax.symbols || {
        start: "\\(",
        end: "\\)",
    };
            ...
            body: {
                ...
                items: [
                    ...
                    },
                    {
                        type: "htmlpanel",
                        html:
                            '<div style="text-align:right"><a href="https://wikibooks.org/wiki/LaTeX/Mathematics" target="_blank" style="font-size:small">LaTex</a></div>',
                    },
                    {
                        type: "htmlpanel",
                        html:
